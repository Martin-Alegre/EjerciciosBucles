...
// Ejercicio 7 //
const familia = [
    { nombre: "martin", edad: 50, rol: "padre", ciudad: "avellaneda" },
    { nombre: "pedro", edad: 45, rol: "madre", ciudad: "quilmes" },
    { nombre: "juan", edad: 20, rol: "hijo", ciudad: "wilde" },
    { nombre: "maria", edad: 18, rol: "hijo", ciudad: "bandfield" },
    { nombre: "alberto", edad: 88, rol: "abuelo", ciudad: "lanus" }
  ];
